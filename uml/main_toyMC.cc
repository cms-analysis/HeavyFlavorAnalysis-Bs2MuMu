...
int main(int argc, char** argv) {
  ...
  pdf_toyMC toy1(print, input_estimates, "all", BF, SM, bd_const, inputs, (!simul_all) ? inputs_bdt : 1, inputs_all, pee, bdt_fit, ch_s, sig_meth, asimov, syst, randomsyst, NExp, Bd, bias_s);
  toy1.initialize();
