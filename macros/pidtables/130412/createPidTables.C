...
void makeAll(const char *dir = ".") {
  ...
  read1File(Form("%s/TnP_MVATM.root", dir), "",          Form("%s/MVATM_data_all.dat", dir)); 
  read1File(Form("%s/TnP_MVATM.root", dir), "_seagulls", Form("%s/MVATM_data_seagulls.dat", dir)); 
  read1File(Form("%s/TnP_MVATM.root", dir), "_cowboys",  Form("%s/MVATM_data_cowboys.dat", dir)); 
  ...
  read1File(Form("%s/TnP_MVATM.root", dir), "_mc",          Form("%s/MVATM_mc_all.dat", dir)); 
  read1File(Form("%s/TnP_MVATM.root", dir), "_seagulls_mc", Form("%s/MVATM_mc_seagulls.dat", dir)); 
  read1File(Form("%s/TnP_MVATM.root", dir), "_cowboys_mc",  Form("%s/MVATM_mc_cowboys.dat", dir)); 
