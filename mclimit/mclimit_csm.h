 ...
 *  
 *
 *  Created by Jose Lazoflores on 3/15/12.
 *  Copyright 2012 CERN. All rights reserved.
 *
 */
...
public:
	...
	/////////////////////////////////////////////////////////////////////////////////////
	// My additions ---> rate limit calculator for 90% CL
	Double_t s90();      // scale factor on signal which is excluded at exactly 90% CL
	Double_t s90m2();   // variation around the median expected s90 in the bg hypothesis, -2 sigma
	Double_t s90m1();   // variation around the median expected s90 in the bg hypothesis, -1 sigma
	Double_t s90med();  // median expected s90 in the background hypothesis
	Double_t s90p1();   // variation around the median expected s90 in the bg hypothesis, +1 sigma
	Double_t s90p2();   // variation around the median expected s90 in the bg hypothesis, +2 sigma
...
private:
	...
	Double_t s90aux(Int_t); // s90 calculator using a function you pass in.////////////////////////////
