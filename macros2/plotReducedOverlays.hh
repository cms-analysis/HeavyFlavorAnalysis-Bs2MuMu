...
public:
  ...
  plotReducedOverlays(const char *files="anaBmm.v11.files", const char *cuts = "default", const char *dir = "default");
  ~plotReducedOverlays();
  ...
  void makeComparison(std::string sample1, std::string sample2, std::string selection);
