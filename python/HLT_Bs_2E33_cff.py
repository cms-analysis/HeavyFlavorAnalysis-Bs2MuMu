# /users/eaguiloc/Bs_2E33_v1.2_V4/V2 (CMSSW_4_2_0_HLT18)

import FWCore.ParameterSet.Config as cms


HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/eaguiloc/Bs_2E33_v1.2_V4/V2')
)
...
HLTBeginSequence = cms.Sequence( hltTriggerType + HLTL1UnpackerSequence + HLTBeamSpot )
HLT_Dimuon4_Bs_Barrel_v7_Bs2E33v1p2V4 = cms.Path( HLTBeginSequence + hltL1sL1DoubleMu0 + hltPreDimuon4BsBarrel + hltDimuonL1Filtered0 + HLTL2muonrecoSequence + hltDimuonL2PreFiltered0 + HLTL3muonrecoSequence + hltDoubleMu2BarrelBsL3Filtered + HLTEndSequence )
HLT_Dimuon6_Bs_v6_Bs2E33v1p2V4 = cms.Path( HLTBeginSequence + hltL1sL1DoubleMu0 + hltPreDimuon6Bs + hltDimuonL1Filtered0 + HLTL2muonrecoSequence + hltDimuonL2PreFiltered0 + HLTL3muonrecoSequence + hltDoubleMu2Dimuon6BsL3Filtered + HLTEndSequence )
HLT_DoubleMu3p5_Jpsi_Displaced_v2_Bs2E33v1p2V4 = cms.Path( HLTBeginSequence + hltL1sL1DoubleMu0 + hltPreDoubleMu3p5JpsiDisplaced + hltDimuonL1Filtered0 + HLTL2muonrecoSequence + hltDimuonL2PreFiltered0 + HLTL3muonrecoSequence + hltJpsiDisplacedL3Filtered + hltDisplacedmumuVtxProducerJpsi + hltDisplacedmumuFilterJpsi + HLTEndSequence )


HLTriggerFinalPath = cms.Path( HLTBeginSequence + hltFEDSelector + hltTriggerSummaryAOD + hltTriggerSummaryRAW + hltBoolTrue )
HLTSchedule = cms.Schedule( *( HLT_Dimuon4_Bs_Barrel_v7_Bs2E33v1p2V4, HLT_Dimuon6_Bs_v6_Bs2E33v1p2V4, HLT_DoubleMu3p5_Jpsi_Displaced_v2_Bs2E33v1p2V4, HLTriggerFinalPath))
