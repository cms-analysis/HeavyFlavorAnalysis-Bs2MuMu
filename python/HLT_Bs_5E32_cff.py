# /users/eaguiloc/Bs_5E32_v8.1_V5/V3 (CMSSW_3_11_0_HLT20)

import FWCore.ParameterSet.Config as cms


HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/eaguiloc/Bs_5E32_v8.1_V5/V3')
)
...
hltBPTXCoincidenceBs5E32v4p2V1 = cms.EDFilter( "HLTLevel1Activity",
...
hltBPTXCoincidenceBs5E32v6p1V1 = cms.EDFilter( "HLTLevel1Activity",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    daqPartitions = cms.uint32( 1 ),
    ignoreL1Mask = cms.bool( True ),
    invert = cms.bool( False ),
...
hltBPTXCoincidenceBs5E32v8p1V5 = cms.EDFilter( "HLTLevel1Activity",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    daqPartitions = cms.uint32( 1 ),
    ignoreL1Mask = cms.bool( True ),
    invert = cms.bool( False ),
...
HLTBeginSequenceBPTXBs5E32v4p2V1 = cms.Sequence( hltTriggerType + HLTL1UnpackerSequence + hltBPTXCoincidenceBs5E32v4p2V1 + HLTBeamSpot )
...
HLTL2muonrecoNocandSequenceBs5E32v4p2V1 = cms.Sequence( HLTmuonlocalrecoSequence + hltL2MuonSeeds + hltL2Muons )
HLTL2muonrecoSequenceBs5E32v4p2V1 = cms.Sequence( HLTL2muonrecoNocandSequenceBs5E32v4p2V1 + hltL2MuonCandidates )
...
HLTBeginSequenceBPTXBs5E32v6p1V1 = cms.Sequence( hltTriggerType + HLTL1UnpackerSequence + hltBPTXCoincidenceBs5E32v6p1V1 + HLTBeamSpot )
HLTL2muonrecoNocandSequenceBs5E32v6p1V1 = cms.Sequence( HLTmuonlocalrecoSequence + hltL2MuonSeeds + hltL2Muons )
HLTL2muonrecoSequenceBs5E32v6p1V1 = cms.Sequence( HLTL2muonrecoNocandSequenceBs5E32v6p1V1 + hltL2MuonCandidates )
HLTBeginSequenceBPTXBs5E32v8p1V5 = cms.Sequence( hltTriggerType + HLTL1UnpackerSequence + hltBPTXCoincidenceBs5E32v8p1V5 + HLTBeamSpot )
HLTMuonLocalRecoSequence = cms.Sequence( hltMuonDTDigis + hltDt1DRecHits + hltDt4DSegments + hltMuonCSCDigis + hltCsc2DRecHits + hltCscSegments + hltMuonRPCDigis + hltRpcRecHits )
HLTL2muonrecoNocandSequenceBs5E32v8p1V5 = cms.Sequence( HLTMuonLocalRecoSequence + hltL2MuonSeeds + hltL2Muons )
HLTL2muonrecoSequenceBs5E32v8p1V5 = cms.Sequence( HLTL2muonrecoNocandSequenceBs5E32v8p1V5 + hltL2MuonCandidates )
HLTBeginSequence = cms.Sequence( hltTriggerType + HLTL1UnpackerSequence + HLTBeamSpot )
HLT_DoubleMu3_Bs_v1_Bs5E32v4p2V1 = cms.Path( HLTBeginSequenceBPTXBs5E32v4p2V1 + hltL1sL1DoubleMu0 + hltPreDoubleMu0Bs + hltDiMuonL1Filtered0 + HLTL2muonrecoSequenceBs5E32v4p2V1 + hltDiMuonL2PreFiltered2 + HLTL3muonrecoSequence + hltDiMuonL3PreFiltered3Onia + hltDoubleMu3BsL3Filtered + HLTEndSequence )
HLT_DoubleMu3_Jpsi_v1_Bs5E32v4p2V1 = cms.Path( HLTBeginSequenceBPTXBs5E32v4p2V1 + hltL1sL1DoubleMu0 + hltPreDoubleMu0Jpsi + hltDiMuonL1Filtered0 + HLTL2muonrecoSequenceBs5E32v4p2V1 + hltDiMuonL2PreFiltered2 + HLTL3muonrecoSequence + hltDiMuonL3PreFiltered3Onia + hltDoubleMu3JpsiL3Filtered + HLTEndSequence )


HLT_DoubleMu2_Bs_v1_Bs5E32v6p1V1 = cms.Path( HLTBeginSequenceBPTXBs5E32v6p1V1 + hltL1sL1DoubleMu0 + hltPreDoubleMu0Bs + hltDiMuonL1Filtered0 + HLTL2muonrecoSequenceBs5E32v6p1V1 + hltDiMuonL2PreFiltered1 + HLTL3muonrecoSequence + hltDiMuonL3PreFiltered2Bs + hltDoubleMu2BsL3Filtered + HLTEndSequence )
HLT_DoubleMu3_Jpsi_v2_Bs5E32v6p1V1 = cms.Path( HLTBeginSequenceBPTXBs5E32v6p1V1 + hltL1sL1DoubleMu0 + hltPreDoubleMu0Jpsi + hltDiMuonL1Filtered0 + HLTL2muonrecoSequenceBs5E32v6p1V1 + hltDiMuonL2PreFiltered2 + HLTL3muonrecoSequence + hltDiMuonL3PreFiltered3Jpsi + hltDoubleMu3JpsiL3Filtered + HLTEndSequence )


HLT_Dimuon6p5_Jpsi_v1_Bs5E32v8p1V5 = cms.Path( HLTBeginSequenceBPTXBs5E32v8p1V5 + hltL1sL1DoubleMu0 + hltPreDimuon6p5Jpsi + hltDimuonL1Filtered0 + HLTL2muonrecoSequenceBs5E32v8p1V5 + hltDimuonL2PreFiltered0 + HLTL3muonrecoSequence + hltDimuonL3PreFiltered0Jpsi + hltDimuon6p5JpsiL3Filtered + HLTEndSequence )
HLT_DoubleMu2_Bs_v2_Bs5E32v8p1V5 = cms.Path( HLTBeginSequenceBPTXBs5E32v8p1V5 + hltL1sL1DoubleMu0 + hltPreDoubleMu0Bs + hltDiMuonL1Filtered0 + HLTL2muonrecoSequenceBs5E32v8p1V5 + hltDiMuonL2PreFiltered1 + HLTL3muonrecoSequence + hltDiMuonL3PreFiltered2Bs + hltDoubleMu2BsL3Filtered + HLTEndSequence )
HLT_Dimuon6p5_Jpsi_Displaced_v1_Bs5E32v8p1V5 = cms.Path( HLTBeginSequenceBPTXBs5E32v8p1V5 + hltL1sL1DoubleMu0 + hltPreDimuon6p5JpsiDisplaced + hltDimuonL1Filtered0 + HLTL2muonrecoSequenceBs5E32v8p1V5 + hltDimuonL2PreFiltered0 + HLTL3muonrecoSequence + hltDimuonL3PreFiltered0JpsiDisplaced + hltDimuon6p5JpsiDisplacedL3Filtered + hltDisplacedmumuVtxProducerJpsi + hltDisplacedmumuFilterJpsi + HLTEndSequence )


HLTriggerFinalPath = cms.Path( HLTBeginSequence + hltFEDSelector + hltTriggerSummaryAOD + hltTriggerSummaryRAW + hltBoolTrue )
HLTSchedule = cms.Schedule( *( HLT_DoubleMu3_Bs_v1_Bs5E32v4p2V1, HLT_DoubleMu3_Jpsi_v1_Bs5E32v4p2V1, HLT_DoubleMu2_Bs_v1_Bs5E32v6p1V1, HLT_DoubleMu3_Jpsi_v2_Bs5E32v6p1V1, HLT_Dimuon6p5_Jpsi_v1_Bs5E32v8p1V5, HLT_DoubleMu2_Bs_v2_Bs5E32v8p1V5, HLT_Dimuon6p5_Jpsi_Displaced_v1_Bs5E32v8p1V5, HLTriggerFinalPath))
