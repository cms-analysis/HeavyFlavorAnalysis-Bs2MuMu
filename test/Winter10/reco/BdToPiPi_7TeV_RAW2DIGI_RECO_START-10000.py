...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:BdToPiPi_7TeV_GEN_SIM_DIGI_L1_DIGI2RAW_HLT_START-10000.root')
)
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('BdToPiPi_7TeV_RAW2DIGI_RECO_START-10000.root'),
