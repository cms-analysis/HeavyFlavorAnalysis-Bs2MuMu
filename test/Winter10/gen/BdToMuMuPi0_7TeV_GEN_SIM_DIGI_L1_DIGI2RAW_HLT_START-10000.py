...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('BdToMuMuPi0_7TeV_GEN_SIM_DIGI_L1_DIGI2RAW_HLT_START-10000.root'),
...
process.generator = cms.EDFilter("Pythia6GeneratorFilter",
    ExternalDecays = cms.PSet(
        EvtGen = cms.untracked.PSet(
            ...
            user_decay_file = cms.FileInPath('HeavyFlavorAnalysis/Bs2MuMu/data/Bd_mumupi0.dec'),
    ...
    filterEfficiency = cms.untracked.double(3.2e-03),
