...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('BdToPiMuNu_7TeV_GEN_SIM_DIGI_L1_DIGI2RAW_HLT_START-10000.root'),
...
#process.KFromBs = cms.EDFilter("PythiaFilter",
#    MaxEta = cms.untracked.double(2.5),
#    Status = cms.untracked.int32(1),
#    MinEta = cms.untracked.double(-2.5),
#    MinPt  = cms.untracked.double(2.5),
...
process.mumugenfilter = cms.EDFilter("PythiaDauVFilter",
    ...
    MaxEta = cms.untracked.vdouble(2.5,2.5,10.),
    MinEta = cms.untracked.vdouble(-2.5,-2.5,-10.),
    MinPt  = cms.untracked.vdouble(2.5,2.5,0.)
#    MaxEta = cms.untracked.double(5.),
#    MinEta = cms.untracked.double(-5.),
#    MinPt  = cms.untracked.double(2.5)
)
