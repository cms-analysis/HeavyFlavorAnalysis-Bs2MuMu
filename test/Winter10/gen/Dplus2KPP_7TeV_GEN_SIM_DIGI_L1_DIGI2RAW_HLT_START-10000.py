...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/HeavyFlavorAnalysis/Bs2MuMu/test/Winter10/gen/Dplus2KPP_7TeV_GEN_SIM_DIGI_L1_DIGI2RAW_HLT_START-10000.py,v $')
)
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('Dplus2KPP_7TeV_GEN_SIM_DIGI_L1_DIGI2RAW_HLT_START-10000.root'),
...
process.MyFilter = cms.EDFilter("PythiaDauVFilter",
    ...
    MinPt  = cms.untracked.vdouble(0.4,0.4,0.4)
)
...
process.ProductionFilterSequence = cms.Sequence(process.generator*process.MyFilter)
#process.ProductionFilterSequence = cms.Sequence(process.generator*process.MuFromBs*process.KFromBs*process.mumugenfilter)
#process.ProductionFilterSequence = cms.Sequence(process.generator*process.MuFromBs*process.KFromBs)
