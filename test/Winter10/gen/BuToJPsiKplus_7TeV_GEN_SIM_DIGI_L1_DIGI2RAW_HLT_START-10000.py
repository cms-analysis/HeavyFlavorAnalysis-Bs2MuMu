...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('December09: Pythia6+EvtGen generation of Bu->J/PsiK+->MuMuK+, 10TeV, D6T tune'),
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_BuToJPsiK_10TeV_noPtCut_cff.py,v $')
)
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('BuToJPsiKplus_7TeV_GEN_SIM_DIGI_L1_DIGI2RAW_HLT_START-10000.root'),
...
process.generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    filterEfficiency = cms.untracked.double(2.4e-03),
