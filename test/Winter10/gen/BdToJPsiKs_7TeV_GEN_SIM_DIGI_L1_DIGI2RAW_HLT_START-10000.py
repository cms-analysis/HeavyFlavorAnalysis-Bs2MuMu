...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('October09: Pythia6+EvtGen generation of Bd->J/PsiKs->MuMuPiPi, 7TeV, D6T tune'),
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_BsToJPsiKs_7TeV_noPtCut_cff.py,v $')
)
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('BdToJPsiKs_7TeV_GEN_SIM_DIGI_L1_DIGI2RAW_HLT_START-10000.root'),
...
process.generator = cms.EDFilter("Pythia6GeneratorFilter",
    ExternalDecays = cms.PSet(
        EvtGen = cms.untracked.PSet(
            ...
            user_decay_file = cms.FileInPath('HeavyFlavorAnalysis/Bs2MuMu/data/Bd_JpsiKs_mumu.dec'),
    ...
    filterEfficiency = cms.untracked.double(2.6e-03),
