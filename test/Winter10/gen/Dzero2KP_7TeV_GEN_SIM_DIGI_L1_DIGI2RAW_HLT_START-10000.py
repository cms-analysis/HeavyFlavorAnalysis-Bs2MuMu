...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/HeavyFlavorAnalysis/Bs2MuMu/test/Winter10/gen/Dzero2KP_7TeV_GEN_SIM_DIGI_L1_DIGI2RAW_HLT_START-10000.py,v $')
)
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('Dzero2KP_7TeV_GEN_SIM_DIGI_L1_DIGI2RAW_HLT_START-10000.root'),
