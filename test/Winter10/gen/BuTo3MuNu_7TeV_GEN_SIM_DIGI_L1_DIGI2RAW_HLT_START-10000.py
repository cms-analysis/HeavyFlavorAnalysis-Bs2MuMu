...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('BuTo3MuNu_7TeV_GEN_SIM_DIGI_L1_DIGI2RAW_HLT_START-10000.root'),
...
#            user_decay_file = cms.FileInPath('GeneratorInterface/ExternalDecays/data/Bs_mumu.dec'),
            user_decay_file = cms.FileInPath('HeavyFlavorAnalysis/Bs2MuMu/data/Bu_3munu.dec'),
