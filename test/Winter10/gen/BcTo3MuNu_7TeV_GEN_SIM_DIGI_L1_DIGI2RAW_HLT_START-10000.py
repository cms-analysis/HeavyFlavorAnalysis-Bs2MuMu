...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/HeavyFlavorAnalysis/Bs2MuMu/test/Winter10/gen/BuTo3MuNu_7TeV_GEN_SIM_DIGI_L1_DIGI2RAW_HLT_START-10000.py,v $')
)
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('BcTo3MuNu_7TeV_GEN_SIM_DIGI_L1_DIGI2RAW_HLT_START-10000.root'),
...
#            user_decay_file = cms.FileInPath('GeneratorInterface/ExternalDecays/data/Bs_mumu.dec'),
            user_decay_file = cms.FileInPath('HeavyFlavorAnalysis/Bs2MuMu/data/Bc_3munu.dec'),
            list_forced_decays = cms.vstring('MyB_c+', 
#                'Myanti-B_s0'),
                'Myanti-B_c+'),
