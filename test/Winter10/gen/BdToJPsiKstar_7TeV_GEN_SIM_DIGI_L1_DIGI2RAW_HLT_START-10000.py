...
# with command line options: Configuration/GenProduction/python/PYTHIA6_BsToMuMu_10TeV_noPtCut_cff.py -s GEN:ProductionFilterSequence,SIM,DIGI,L1,DIGI2RAW,HLT --conditions FrontierConditions_GlobalTag,MC_31X_V5::All --datatier GEN-SIM-RAW --eventcontent RAWSIM -n 10 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('December09: Pythia6+EvtGen generation of Bd->J/PsiKstar->MuMuKPi, 7TeV, D6T tune'),
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_BdToJPsiKstar_7TeV_noPtCut_cff.py,v $')
)
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('BdToJPsiKstar_7TeV_GEN_SIM_DIGI_L1_DIGI2RAW_HLT_START-10000.root'),
...
# Additional output definition from Urs and Bora
...
process.MuFromJPsi = cms.EDFilter("PythiaFilter",
...
process.generator = cms.EDFilter("Pythia6GeneratorFilter",
    ExternalDecays = cms.PSet(
        EvtGen = cms.untracked.PSet(
            ...
            user_decay_file = cms.FileInPath('HeavyFlavorAnalysis/Bs2MuMu/data/Bd_JpsiKstar_mumuKpi.dec'),
    ...
    filterEfficiency = cms.untracked.double(2e-03),
    ...
    PythiaParameters = cms.PSet(
        ...
        bbbarSettings = cms.vstring('PMAS(5,1)=4.8          ! b quark mass', 
            'MSEL=1                 ! Min Bias'), 
#            'MDME(614,1) = 0        ', 
#            'MDME(613,1) = 1       !  Ks->pi+pi- '),
        parameterSets = cms.vstring('pythiaUESettings', 
            'bbbarSettings')
    )
)
process.ProductionFilterSequence = cms.Sequence(process.generator*process.MuFromJPsi*process.mumugenfilter)
