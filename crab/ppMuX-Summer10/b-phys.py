...
# ----------------------------------------------------------------------
rootFileName = "bmm-ppMuX-Summer10.root"
...
process.triggerDump.HLTResultsLabel = cms.untracked.InputTag("TriggerResults::RECO")
process.triggerDump.TriggerEventLabel = cms.untracked.InputTag("hltTriggerSummaryAOD::REDIGI37X")
